...
export default class claimDYP extends React.Component {
                                    ...
                                    <div className="farming-content">
                                        <div className="row">
                                            <div className="col-lg-4">
                                                <a href="https://app-bsc.dyp.finance/vesting" target="_blank">
                                            ...
                                            <div className="col-lg-4">
                                                <a href="https://app-avax.dyp.finance/vesting" target="_blank">
                                                    <div className="fariming-item">
                                                        <div className="icon">
