            ...
            <div class="about-her-wrapper">
              <div class="row  align-items-center">
                <div class="col-lg-6 order-2 order-lg-1">
                  <div class="left">
                    <h3 className="mt-4 mt-lg-0 aboutus-subtitle">Hi</h3>
                    <h1>
                      We're{" "}
                      <a
                        className="aboutus-title"
                        style={{ color: "var(--accent-red-nft)" }}
                      >
                        DeFi Yield Protocol
                      </a>
                    </h1>
                    <p>
                      ...
                      powerful decentralized ecosystem that faces the future. In
                      addition to a variety of products and services currently
                      offered like yield farming and staking, we are constantly
                      building and expanding our scope to include more advanced
                      DeFi and educational tools, NFTs and even Metaverse
                      gaming, making us accessible for both beginner and
                      advanced users. <br /> <br />
                      DYP made history in the DeFi space by becoming the first
                      and only protocol to reward users in Ethereum. The
                      protocol employs an anti-manipulation feature that aims to
                      limit the market impact on users converting rewards into
                      ETH and other native platform tokens. Anti-manipulation
                      allows DeFi Yield Protocol to maintain stability, fair
                      access to liquidity, and provide a secure and simplified
                      DeFi platform for users of all sizes. <br /> <br /> In
                      addition, DYP also provides its core feature of
