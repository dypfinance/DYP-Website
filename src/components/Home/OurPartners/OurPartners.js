        ...
        <div className="col partners-flex-col d-flex    align-items-start">
          <div className="row d-flex  flex-nowrap flex-md-wrap justify-content-center">
            {partnersArray.length > 0 &&
              partnersArray.slice(0, 4).map((item, id) => (
            ...
            {partnersArray.length > 0 &&
              partnersArray.slice(4, 8).map((item, id) => (
                <div className=" col-md-3" key={id}>
                  <OurPartnersItem
                    image={item.image}
                    text={item.text}
            ...
            {partnersArray.length > 0 &&
              partnersArray.slice(8, 12).map((item, id) => (
                <div className=" col-md-3" key={id}>
                  <OurPartnersItem
                    image={item.image}
                    text={item.text}
            ...
            {partnersArray.length > 0 &&
              partnersArray.slice(12, 16).map((item, id) => (
                <div className=" col-md-3" key={id}>
                  <OurPartnersItem
                    image={item.image}
                    text={item.text}
            ...
            {partnersArray.length > 0 &&
              partnersArray.slice(16, 22).map((item, id) => (
                <div className=" col-md-3" key={id}>
                  <OurPartnersItem
                    image={item.image}
                    text={item.text}
