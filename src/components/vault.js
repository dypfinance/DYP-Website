                 ...
                 <div className="col-lg-8  offset-lg-2">
                    ...
                    <div className="participar-item">
                       <div className="participar-item-header">
                          ...
                          <div className="right">
                             <a href="https://vault.dyp.finance/vault-list-eth" target='_blank'>Supply</a>
                          </div>
                       </div>
                    ...
                    <div className="participar-item">
                       <div className="participar-item-header">
                          ...
                          <div className="right">
                             <a href="https://vault.dyp.finance/vault-list-wbtc" target='_blank'>Supply</a>
                          </div>
                       </div>
                       <div className="participar-item-content">
                          <div className="left">
                    ...
                    <div className="participar-item">
                       <div className="participar-item-header">
                          ...
                          <div className="right">
                             <a href="https://vault.dyp.finance/vault-list-usdt" target='_blank'>Supply</a>
                          </div>
                       </div>
                       <div className="participar-item-content">
                          <div className="left">
                    ...
                    <div className="participar-item">
                       <div className="participar-item-header">
                          ...
                          <div className="right">
                             <a href="https://vault.dyp.finance/vault-list-usdc" target='_blank'>Supply</a>
                          </div>
                       </div>
                       <div className="participar-item-content">
                          <div className="left">
                    ...
                    <div className="participar-item">
                       <div className="participar-item-header">
                          ...
                          <div className="right">
                             <a href="https://vault.dyp.finance/vault-list-dai" target='_blank'>Supply</a>
                          </div>
                       </div>
                       <div className="participar-item-content">
                          <div className="left">
