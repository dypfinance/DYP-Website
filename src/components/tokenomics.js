...
export default class Tokenomics extends React.Component {
  ...
  getChainData = async () => {
    await axios
      ...
      .then((data) => {
       this.setState({
        bnbSupply: data.data.bsc,
        avaxSupply: data.data.avax
       })
      });
  };
        ...
        <div className="p4dyp">
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-10 offset-lg-1 justify-content-start">
                <div className="p4dyp-content-one-left justify-content-start m-auto w-100">
                  <h4 className="w-100">DYP on BNB Chain</h4>
                </div>
                <div
                  className="d-grid d-md-flex justify-content-start m-auto"
                  style={{ gap: 40 }}
                >
                  ...
                  >
                    <div className="p4dyp-content-one-left">
                      ...
                      <h3> {getFormattedNumber(this.state.bnbSupply.locked, 2)} DYP</h3>
                    </div>
                  ...
                  >
                    <div className="p4dyp-content-one-left">
                      ...
                      <h3>{getFormattedNumber(this.state.bnbSupply.unlocked, 2)} DYP</h3>
                    </div>
                    
                  </div>
                </div>
              </div>
              <div className="col-lg-10 offset-lg-1 justify-content-start position-relative">

                <div className="p4dyp-content-one-left justify-content-start m-auto w-100">
                  <h4 className="w-100">DYP on Avalanche</h4>
                </div>
                ...
                >
                  ...
                  >
                    <div className="p4dyp-content-one-left">
                      ...
                      <h3> {getFormattedNumber(this.state.avaxSupply.locked, 2)} DYP</h3>
                    </div>
                  ...
                  >
                    <div className="p4dyp-content-one-left">
                      ...
                      <h3>{getFormattedNumber(this.state.avaxSupply.unlocked, 2)} DYP</h3>
                    </div>
                    
                  </div>
                </div>
              {/* <img src={require('../assets/images/graphavax.png')} alt='' style={{width: 290, objectFit: 'contain'}}/> */}

              </div>
              {/* <div className="col-lg-10 offset-lg-1 justify-content-start position-relative">

                <div className="p4dyp-content-one-left justify-content-start m-auto w-100">
                  <h4 className="w-100">Total Tokenomics Avalanche & BNB Chain</h4>
                </div>
