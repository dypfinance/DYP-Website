              ...
              <div className="col-lg-10 offset-lg-1">
                <div>
                  ...
                  >
                    ...
                    <div className="col-lg-12 offset-lg-2 ml-0 p-0 d-flex">
                      <div
                        className="p4token-content-one col-lg-8 p4token-wrapper"
                        style={{ display: "grid", padding: 25 }}
                      >
                      ...
                      <div className="supplyCirculated col-lg-4 p-0">
                        <p style={{ fontSize: 12 }}>
                ...
                <div className="p4dyp-wrapper">
                  <div className="p4dyp-heading">
                    ...
                    <p>
                      ...
                      accessible over the course of 2 years. <br />
                  ...
                  <div className="p4dyp-content">
                    <div className="p4dyp-content-one">
                      ...
                      <div className="p4dyp-content-one-left">
                        <h4>1,214,111 DYP</h4>
                        <p>
                          Distributed for providing liquidity to Centralized
                          Exchanges and Marketing Purposes
                        </p>
                      </div>
                      <div className="p4dyp-content-one-left">
                        <h4>2,584,689 DYP</h4>
                      ...
                      <div
                        className="p4dyp-content-one-left"
                    ...
                    <div className="p4dyp-content-one">
                      ...
                      >
                        ...
                        <p style={{ wordWrap: "break-word" }}>
                          BURNED & REMOVED from the total supply TH: <br />
                          <a
                  ...
                  <div className="p4dyp-can">
                    <p id="noadd">
                      <strong>No Additional Tokens Can Be Minted!</strong>
                    </p>
                  </div>
                </div>
              </div>
