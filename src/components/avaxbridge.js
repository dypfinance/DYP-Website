                        ...
                        <div className="earn-hero-wrapper">
                            <div className="row">
                                ...
                                <div className="col-lg-4">
                                    <div className="earn-hero-content p4token-wrapper">
                                        <div className='text-left'>
                                            <p className='h3'><b>iDYP AVAX Bridge</b></p>
                                            <p>The Bridge will help you swap iDYP tokens between Ethereum Network and Avalanche Network.</p>
                                            <p>Visit <a target='_blank' href='https://avax-ibridge.dyp.finance'>avax-ibridge.dyp.finance</a> to start using the DeFi Yield Protocol Bridge</p>
                                            <div style={{display: 'flex'}}>
                                                <div className="earn-hero-btns-bridge m-0">
                                                    <a target='_blank' className='m-0' href="https://dypfinance.medium.com/defi-yield-protocol-avalanche-bridge-tutorial-9404d827a4a">DYP Bridge Tutorial</a>
                                                </div>
