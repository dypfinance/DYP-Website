...
export default class AvaxStakeV2 extends React.Component {
                                ...
                                <div className="col-lg-8  offset-lg-2">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app-avax.dyp.finance/constant-staking-1" target='_blank'>Deposit</a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app-avax.dyp.finance/constant-staking-2" target='_blank'>Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
