...
export default class ReferralV2Avax extends React.Component {
    render() {
        return (
            <>
                                ...
                                <div className="col-lg-8  offset-lg-2">
                                    <div className="earn-hero-content p4token-wrapper">
                                        <div className='text-left'>
                                            <p className='h3'><b>DYP Referral Avalanche</b></p>
                                            ...
                                            <p>Visit <a target='_blank' href='https://app-avax.dyp.finance/constant-staking-2'>app-avax.dyp.finance</a> to get your Referral link.</p>
