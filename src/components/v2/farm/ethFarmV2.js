...
export default class EthFarmV2 extends React.Component {
    ...
    getTotalTvl = async () => {
        ...
        /* Calculate with DYPS */
        let tokensFarmingDYPS = await window.getTokenHolderBalanceDYPS('0xa68BBe793ad52d0E62bBf34A67F02235bA69E737',1) / 1e18
        let tokensFarmingDYPS1 = await window.getTokenHolderBalanceDYPS('0xCFd970494a0b3C52a81dcE1EcBFF2245e6b0B0E7',1) / 1e18
        let tokensFarmingDYPS2 = await window.getTokenHolderBalanceDYPS('0x49D02CF81Cc352517350F25E200365360426aF94',1) / 1e18
        let tokensFarmingDYPS3 = await window.getTokenHolderBalanceDYPS('0xf51965c570419F2576ec9AeAD6A3C5F674424A99',1) / 1e18
        let tokensFarmingDYPS4 = await window.getTokenHolderBalanceDYPS('0x997A7254E5567d0A70329DEFCc1E4d29d71Ba224',1) / 1e18
                                ...
                                <div className="col-lg-8  offset-lg-2">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app.dyp.finance/farming-new-1">Deposit</a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app.dyp.finance/farming-new-2">Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app.dyp.finance/farming-new-3">Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app.dyp.finance/farming-new-4">Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app.dyp.finance/farming-new-5">Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
