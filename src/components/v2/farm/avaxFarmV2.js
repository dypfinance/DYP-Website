                                ...
                                <div className="col-lg-8  offset-lg-2">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app-avax.dyp.finance/farming-new-1" target='_blank'>Deposit</a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app-avax.dyp.finance/farming-new-2" target='_blank'>Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app-avax.dyp.finance/farming-new-3" target='_blank'>Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app-avax.dyp.finance/farming-new-4" target='_blank'>Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app-avax.dyp.finance/farming-new-5" target='_blank'>Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
