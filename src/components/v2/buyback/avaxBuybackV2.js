                                ...
                                <div className="col-lg-8  offset-lg-2">
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app-avax.dyp.finance/staking-buyback-1" target='_blank'>Deposit</a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="participar-item">
                                        <div className="participar-item-header">
                                            ...
                                            <div className="right">
                                                <a href="https://app-avax.dyp.finance/staking-buyback-2" target='_blank'>Deposit</a>
                                            </div>
                                        </div>
                                        <div className="participar-item-content">
                                            <div className="left">
