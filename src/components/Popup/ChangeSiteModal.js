...
const ChangeSiteModal = ({onModalClose, modalState}) => {
  ...
  return (
    <div className={`change-site-modal ${modalState && 'change-modal-open'} d-flex flex-column align-items-center justify-content-center px-5 pb-5 gap-3`} id="changeModal">
