                        ...
                        <div className="col-md-5">
                            <div className="image-placeholder">
                                <div className={`elevated-container ${createdNft.image && 'bg'}`}>
                                    ...
                                    <div className="image">
                                        {totalCreated > 0 && <div className="number-created-nfts-pill">
                                            {totalCreated} Created
                                        </div>}
                                        {createdNft.image ?
                                            <img src={createdNft.image} className='nft-img' data-toggle="modal" data-target="#newNft" />
                                            :
                                            <div className='placeholder-content'>
                                                <img src={require("../../../../../assets/Nft/cat_desktop.png")} alt="" className="placeholder-content-img" />
                                                <p className='placeholder-content-text'>Your NFT preview will be generated here</p>
                                            </div>}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="col-12 ">
                                    <div className="connect-wallet">
                                        <div className="elevated-container">
                                            <div className="info">
                                                <div className={`wallet-image ${connectedWallet ? 'wallet-image-connected' : ""} `}>
                                                    {connectedWallet ? <img src={require("../../../../../assets/General/checked-icon.svg").default} alt="" /> : <img src={require("../../../../../assets/General/wallet-icon.svg").default} alt="" />}

                                                </div>
                                                <p>
                                                    {connectedWallet ? "Wallet has been connected" : "Please connect your wallet"}
                                                </p>
                                            </div>
                                            {connectedWallet ?
                                                <div className="connected-wallet cursor-pointer" onClick={copyAddress}>
                                            ...
                                            :
                                                <button className='btn btn-outline-primary ' onClick={handleConnectWallet}>Connect Wallet</button>
                                            }
                                        ...
                                        <div className="elevated-container">
                                            ...
                                            <div className="row name-description">
                                                <div className="col-md-5 d-flex flex-column">
                                                    ...
                                                    <p className='name-data'>{nftName && '#'}{nftName}</p>

                                                </div>
                                                <div className="col-md-7 d-flex flex-column">
                                                    <p className="label">Description</p>
                                                    <div className="desc-data">
                                                        {descriptionTags.length > 0 && descriptionTags.map((item, id) => (
                                                ...
                                                <div className=" col-5 col-md-7 p-0 d-flex align-items-end ">
                                                    <div className='d-flex flex-column-reverse flex-md-row align-items-center w-100'>
                                                        ...
                                                        <div className="buttons">
                                                            <button className={`nft-count-button ${numberOfNfts == 1 && "inactive" || numberOfNfts == "" && 'inactive'}`} onClick={handleNftNumberDown}>
                                                                <img src={require("../../../../../assets/General/minus-icon.png")} alt="" />
                                                            </button>
                                                            <button className='nft-count-button' onClick={handleNftNumberUp}>
                                                                <img src={require("../../../../../assets/General/plus-icon.png")} alt="" />
                                                            </button>
                                                        </div>
