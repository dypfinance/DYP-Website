...
window.config = {
  ...
  nftstaking_address: "0x0fddc65727082d2d590c1f4b16d2e11ba3e00441",
};
...
/**
 *
 * @param {"TOKEN" | "STAKING" | "NFTSTAKING"} key
 */
async function getContract(key) {
  ...
  if (!window.cached_contracts[key]) {
    window.cached_contracts[key] = new window.web3.eth.Contract(ABI, key === 'NFTSTAKING' ? '0x0fddc65727082d2d590c1f4b16d2e11ba3e00441' : address, {
